...
Este documento describe las variables utilizadas para el reemplazo en las plantillas Excel de propuestas de copropiedades.
...
| +6 | cobertura_diferenciadora_1_aseg | Cobertura diferenciadora 1 (texto editable) |
| +7 | cobertura_diferenciadora_2_aseg | Cobertura diferenciadora 2 (texto editable) |
...
Para obtener el número de variable de un campo específico de una aseguradora:

```
Variable = Offset_Base_Aseguradora + Offset_Campo
```

**Ejemplo**: Nombre de la Aseguradora 3
- Offset Base Aseguradora 3: `222`
- Offset Campo nombre: `+0`
- Variable: `[222]`

**Ejemplo**: DM Terremoto Porcentaje de la Aseguradora 2
- Offset Base Aseguradora 2: `131`
- Offset Campo dm_terremoto_porcentaje: `+9`
- Variable: `[140]`
