# Diccionario de Variables - Entrega Vehículos

Este documento describe las variables para la plantilla `entrega_vehiculos.xlsx`.

> **Nota:** La entrega reutiliza todas las variables de propuesta (`[1]`-`[155]`). Consultar `PROPUESTA_VEHICULOS.md`.
