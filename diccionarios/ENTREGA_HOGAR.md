# Diccionario de Variables - Entrega Hogar

Este documento describe las variables para la plantilla `entrega_hogar.xlsx`.

> **Nota:** La entrega reutiliza todas las variables de propuesta (`[1]`-`[115]`). Consultar `PROPUESTA_HOGAR.md`.
