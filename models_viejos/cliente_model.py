...
class Cliente(db.Model):
    ...
    tipo_usuario = db.Column(db.String(10), nullable=False)  # 'AGENTE' o 'CLIENTE' o 'ADMINISTRADOR' o 'SUPERADMIN'
    
    # CAMPOS PARA PERSONA NATURAL (serán NULL si es empresa o administrador o superadmin)
    tipo_documento = db.Column(db.String(10))
    numero_documento = db.Column(db.String(20))
    nombre = db.Column(db.String(150))
    edad = db.Column(db.Integer)
    
    # CAMPOS PARA EMPRESA (serán NULL si es persona o administrador o superadmin)
